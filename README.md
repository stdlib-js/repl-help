...
```javascript
help = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/repl-help@v0.4.0-umd/browser.js' )
```
...
[test-image]: https://github.com/stdlib-js/repl-help/actions/workflows/test.yml/badge.svg?branch=v0.4.0
[test-url]: https://github.com/stdlib-js/repl-help/actions/workflows/test.yml?query=branch:v0.4.0
