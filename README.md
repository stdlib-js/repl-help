...
```javascript
help = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/repl-help@umd/browser.js' )
```
The previous example will load the latest bundled code from the umd branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/repl-help/tags). For example,

```javascript
help = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/repl-help@v0.3.0-umd/browser.js' )
```

To vendor stdlib functionality and avoid installing dependency trees for Node.js, you can use the UMD server build:

```javascript
var help = require( 'path/to/vendor/umd/repl-help/index.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/repl-help@umd/browser.js"></script>
```
...
[test-image]: https://github.com/stdlib-js/repl-help/actions/workflows/test.yml/badge.svg?branch=v0.3.0
[test-url]: https://github.com/stdlib-js/repl-help/actions/workflows/test.yml?query=branch:v0.3.0
...
[deno-readme]: https://github.com/stdlib-js/repl-help/blob/deno/README.md
[umd-url]: https://github.com/stdlib-js/repl-help/tree/umd
[umd-readme]: https://github.com/stdlib-js/repl-help/blob/umd/README.md
[esm-url]: https://github.com/stdlib-js/repl-help/tree/esm
[esm-readme]: https://github.com/stdlib-js/repl-help/blob/esm/README.md
