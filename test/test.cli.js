...
tape( 'the command-line interface prints help text', opts, function test( t ) {
	var cmd = [
		EXEC_PATH,
		fpath,
		'base.sin'
...
tape( 'if unable to resolve help text, the command-line interface sets a non-zero exit code', opts, function test( t ) {
	var cmd = [
		EXEC_PATH,
		fpath,
